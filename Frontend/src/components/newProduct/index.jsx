    ...
    if (formState.isValid) {
      ...
      if (productRes.ok) {
        ...
        const photoRes = await fetch(
          `${process.env.REACT_APP_BACKEND_URL}/products/${body.data.id}/photos`,
          {
            method: "POST",
            headers: {
              Authorization: token,
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                InputLabel={{ style: { fontSize: 90 } }}
                helperText={
                  hasError("manufact_date")
                    ? formState.errors.manufact_date[0]
                    : null
                }
                ...
                <Item>
                  <DropzoneArea
                    ...
                    getFileAddedMessage={(fileName) =>
                      `Archivo ${fileName} cargado`
                    }
                    getFileRemovedMessage={(fileName) =>
                      `Imagen ${fileName} eliminada`
                    }
